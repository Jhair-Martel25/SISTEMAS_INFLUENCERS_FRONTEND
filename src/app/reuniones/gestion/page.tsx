      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <p className="text-gray-500 text-sm mt-1 mb-6">
            Consulta el estado actual de las reuniones programadas.
          </p>
          ...
          <table className="w-full">
            ...
            <tbody>
              ...
              <tr className="border-b hover:bg-green-100 transition-colors">
                <td className="text-center p-3">Andrea Merino</td>
                <td className="text-center p-3">Luis Vega</td>
                <td className="text-center p-3">17 Oct 2023 - 09:00 AM</td>
              ...
              <tr className="border-b hover:bg-blue-100 transition-colors">
                <td className="text-center p-3">Jorge Rivera</td>
                <td className="text-center p-3">Marta Paz</td>
                <td className="text-center p-3">17 Oct 2023 - 11:30 AM</td>
                <td className="text-center p-3">
              ...
              <tr className="border-b hover:bg-red-100 transition-colors">
                <td className="text-center p-3">Carla Salas</td>
                <td className="text-center p-3">Fabio Ruiz</td>
                <td className="text-center p-3">17 Oct 2023 - 03:00 PM</td>
                <td className="text-center p-3">
